...
,
  ...
  // ── ESF Papers — Prüfungsrelevante Studien ───────────────────────────────
  {
    id: "esf-paper1-ai-assessment-effect",
    type: "localvideo",
    course: "ESF", courseColor: "#7c3aed",
    emoji: "🤖",
    title: "AI Assessment Effect",
    subtitle: "Goergen, de Bellis & Klesse (2025) — PNAS — DAS Lehrpaper",
    description: "Menschen verhalten sich anders wenn eine KI sie bewertet: AI Assessment Effect, Lay Beliefs, UV/AV/Mediator, Between-Subjects-Design, N=13'342.",
  ...
  {
    id: "esf-paper2-doppelgaenger-brand-image",
    type: "localvideo",
    course: "ESF", courseColor: "#7c3aed",
    emoji: "👥",
    title: "Doppelgänger Brand Image",
    subtitle: "Thompson, Rindfleisch & Arsel (2006) — Journal of Marketing",
    description: "Starke emotionale Marken erzeugen ihr eigenes Gegenbild. Qualitative Studie, hermeneutische Analyse, strategische Implikationen.",
  ...
  {
    id: "esf-paper3-open-science-replikationskrise",
    type: "localvideo",
    course: "ESF", courseColor: "#7c3aed",
    emoji: "💥",
    title: "Open Science & Replikationskrise",
    subtitle: "Ioannidis (2005) + Open Science Collaboration (2015)",
    description: "Nur 36% der Psychologie-Studien replizierbar. Publikationsbias, p-Hacking, HARKing — und wie Open Science dagegen hilft.",
  ...
  {
    id: "esf-paper4-luca-korrelation-kausalitaet",
    type: "localvideo",
    course: "ESF", courseColor: "#7c3aed",
    emoji: "📈",
    title: "Korrelation ≠ Kausalität",
    subtitle: "Luca (2021) — Harvard Business Review",
    description: "Mehr Schokolade = mehr Nobelpreise? Warum Führungskräfte Korrelation nicht mit Kausalität verwechseln dürfen — und wann Experimente notwendig sind.",
  ...
  {
    id: "esf-paper5-de-bellis-manual-labor",
    type: "localvideo",
    course: "ESF", courseColor: "#7c3aed",
    emoji: "🔧",
    title: "Meaning of Manual Labor",
    subtitle: "de Bellis et al. (2023) — Journal of Marketing",
    description: "Autonome Produkte stehlen uns den Sinn manueller Arbeit. Multi-Study-Design, Mediator-Mechanismus, Adoption von Technologie.",
...
,
  {
    id: "makro-r1-1-preis-zins",
    type: "localvideo",
    course: "MakroII", courseColor: "#059669",
    emoji: "📉",
    title: "Preis steigt, Zins sinkt — immer",
    subtitle: "Die inverse Relation — Prüfungsfalle #1",
    description: "Die inverse Relation von Anleihepreis und Zins: Warum Preis hoch gleich Zins tief. Barwertformel erklärt, häufigste Prüfungsfalle in Makro.",
    topics: ["Anleihen", "Barwertformel", "Inverse Relation", "Zinsen", "Pr\u00fcfungsfalle"],
    duration: "1:39",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r1_1_preis_zins.mp4",
    thumbnail_emoji: "📉",
    block: "Block 1 — Finanzmärkte & Geldpolitik"
  },
  {
    id: "makro-r1-2-zinsstrukturkurve",
    type: "localvideo",
    course: "MakroII", courseColor: "#059669",
    emoji: "📊",
    title: "Die Zinsstrukturkurve lügt nie",
    subtitle: "7 von 8 US-Rezessionen korrekt vorhergesagt",
    description: "Zinsstrukturkurve: Normal vs. invers vs. flach. Warum eine inverse Kurve Rezession signalisiert und wie die Erwartungshypothese das erklärt.",
    topics: ["Zinsstrukturkurve", "Invertierte Kurve", "Rezessionsindikator", "Laufzeit", "Rendite"],
    duration: "1:45",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r1_2_zinsstrukturkurve.mp4",
    thumbnail_emoji: "📊",
    block: "Block 1 — Finanzmärkte & Geldpolitik"
  },
  {
    ...
    course: "MakroII", courseColor: "#059669",
    emoji: "🏦",
    title: "QE ist NICHT Gelddrucken",
    subtitle: "Reserven ≠ Geldmenge M1 — der echte Wirkungskanal",
    description: "Quantitative Easing richtig verstehen: QE erhöht Reserven, nicht automatisch M1. Wirkungskanal über Anleihepreise und Zinskanal erklärt.",
    topics: ["QE", "Quantitative Easing", "Zentralbankbilanz", "Reserven", "M1", "Pr\u00fcfungsfalle"],
    duration: "1:47",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r1_3_qe_nicht_gelddrucken.mp4",
    thumbnail_emoji: "🏦",
    block: "Block 1 — Finanzmärkte & Geldpolitik"
  },
  {
    ...
    course: "MakroII", courseColor: "#059669",
    emoji: "🚧",
    title: "Die Nullzinsgrenze (ZLB)",
    subtitle: "Wann konventionelle Geldpolitik versagt",
    description: "Zero Lower Bound: Warum Zinsen nicht beliebig unter null fallen können. Bargeld-Arbitrage, ZLB-Problem und warum Zentralbanken dann QE einsetzen müssen.",
    topics: ["ZLB", "Nullzinsgrenze", "Bargeld-Arbitrage", "Geldpolitik", "QE"],
    duration: "1:53",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r1_4_zlb_nullzinsgrenze.mp4",
    thumbnail_emoji: "🚧",
    block: "Block 1 — Finanzmärkte & Geldpolitik"
  },
  {
    id: "makro-r1-5-arbitrage",
    type: "localvideo",
    course: "MakroII", courseColor: "#059669",
    emoji: "⚖️",
    title: "Arbitrage & Erwartungshypothese",
    subtitle: "Wie langfristige Zinsen aus kurzfristigen entstehen",
    description: "No-Arbitrage-Bedingung und Erwartungshypothese: i_{2t} ≈ (i_{1t} + i^e_{1,t+1})/2. Warum langfristige Zinsen Erwartungen über künftige Kurzfristzinsen spiegeln.",
    topics: ["Arbitrage", "Erwartungshypothese", "Langfristzins", "Kurzfristzins", "No-Arbitrage"],
    duration: "1:46",
    level: "Prüfungsrelevant ⚡",
  ...
  },
  {
    ...
    subtitle: "u'(C₁) = β(1+r)u'(C₂) — die Optimalbedingung",
    description: "Euler-Gleichung für intertemporalen Konsum: Zeitpräferenz Beta, Zins r und abnehmender Grenznutzen. Wann lohnt sich sparen — und warum Zinssenkungen Konsum in die Gegenwart verschieben.",
    topics: ["Euler-Gleichung", "Intertemporaler Konsum", "Zeitpr\u00e4ferenz", "Beta", "Optimum"],
    duration: "1:11",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r2_1_euler_gleichung.mp4",
    thumbnail_emoji: "⏳",
    block: "Block 2 — IS-LM & Konsum"
  },
  {
    id: "makro-r2-2-tobins-q",
    type: "localvideo",
    course: "MakroII", courseColor: "#059669",
    emoji: "🏭",
    title: "Tobins q: Kaufen oder Bauen?",
    subtitle: "q = Marktwert / Wiederbeschaffungskosten",
    description: "Tobins q als Investitionssignal: q > 1 → investieren, q < 1 → am Markt kaufen. Brücke zwischen Aktienmarkt und Realinvestition. Warum Geldpolitik die Börse beobachtet.",
    topics: ["Tobins q", "Investition", "Aktienmarkt", "Marktwert", "Wiederbeschaffungskosten"],
    duration: "1:23",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r2_2_tobins_q.mp4",
    thumbnail_emoji: "🏭",
    block: "Block 2 — IS-LM & Konsum"
  },
  {
    id: "makro-r2-3-is-shift",
    type: "localvideo",
    course: "MakroII", courseColor: "#059669",
    emoji: "📉",
    title: "IS-Kurve: Verschiebung vs. Bewegung",
    subtitle: "G↑ = Shift | r↑ = Bewegung — nie verwechseln",
    description: "Der häufigste Fehler in der Makro-Prüfung: IS-Kurve verschiebt sich bei G↑, T↓, Konsumvertrauen↑. Bewegung entlang der Kurve nur bei Zinsänderung. Mit klarer Faustformel.",
    topics: ["IS-Kurve", "Shift", "Verschiebung", "G\u00fctermarkt", "Staatsausgaben", "Pr\u00fcfungsfalle"],
    duration: "1:19",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r2_3_is_kurve_shift.mp4",
    thumbnail_emoji: "📉",
    block: "Block 2 — IS-LM & Konsum"
  },
  {
    id: "makro-r2-4-multiplikator",
    type: "localvideo",
    course: "MakroII", courseColor: "#059669",
    emoji: "💥",
    title: "Fiskalmultiplikator: Grösser als 1?",
    subtitle: "ΔY = 1/(1−c₁) × ΔG — der Rundlauf-Effekt",
    description: "Fiskalmultiplikator erklärt: Warum 1 CHF Staatsausgabe mehr als 1 CHF BIP erzeugt. Rundlauf-Effekt mit c₁=0.8 → Multiplikator=5. Und wann Crowding-out ihn auf null reduziert.",
    topics: ["Fiskalmultiplikator", "MPC", "Staatsausgaben", "Crowding-out", "Rundlauf"],
    duration: "1:26",
    level: "Prüfungsrelevant ⚡",
    video_src: "https://ifmwcgwfvunjbnfwwbtr.supabase.co/storage/v1/object/public/videos/makro_r2_4_fiskalmultiplikator.mp4",
    thumbnail_emoji: "💥",
    block: "Block 2 — IS-LM & Konsum"
  }
,
