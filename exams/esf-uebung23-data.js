    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          imageHtml: '<div style="margin-top:8px"><div style="display:flex;gap:8px;justify-content:center"><div style="flex:1;background:#1e3a5f;border-radius:8px;padding:10px;text-align:center;border:1px solid #1d4ed8"><p style="font-size:0.6rem;color:#93c5fd;margin-bottom:4px;font-weight:600">KONDITION 1</p><div style="font-size:1.2rem;margin-bottom:4px">😷</div><p style="font-size:0.65rem;color:#bfdbfe;font-weight:600;line-height:1.3;margin-bottom:4px">Schutz vor COVID-19</p><p style="font-size:0.6rem;color:#93c5fd;line-height:1.3">Personlicher Gesundheitsnotfall</p></div><div style="flex:1;background:#1e3a5f;border-radius:8px;padding:10px;text-align:center;border:1px solid #1d4ed8"><p style="font-size:0.6rem;color:#93c5fd;margin-bottom:4px;font-weight:600">KONDITION 2</p><div style="font-size:1.2rem;margin-bottom:4px">🤝</div><p style="font-size:0.65rem;color:#bfdbfe;font-weight:600;line-height:1.3;margin-bottom:4px">Schutz fur sich und andere</p><p style="font-size:0.6rem;color:#93c5fd;line-height:1.3">Personlicher + offentlicher Nutzen</p></div><div style="flex:1;background:#1e3a5f;border-radius:8px;padding:10px;text-align:center;border:1px solid #1d4ed8"><p style="font-size:0.6rem;color:#93c5fd;margin-bottom:4px;font-weight:600">KONDITION 3</p><div style="font-size:1.2rem;margin-bottom:4px">🏘</div><p style="font-size:0.65rem;color:#bfdbfe;font-weight:600;line-height:1.3;margin-bottom:4px">Schutz fur andere</p><p style="font-size:0.6rem;color:#93c5fd;line-height:1.3">Offentlicher Gesundheitsnotfall</p></div></div><p style="font-size:0.65rem;color:#6b7280;text-align:center;margin-top:6px">Between-subjects: Jede/r Teilnehmer*in sah genau einen der drei Flyer</p></div>',
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          imageHtml: '<svg width="210" height="155" style="display:block;background:#1f2937;border-radius:8px;margin-top:8px" xmlns="http://www.w3.org/2000/svg"><line x1="38" y1="125" x2="195" y2="125" stroke="#4b5563" stroke-width="1.5"/><line x1="38" y1="20" x2="38" y2="125" stroke="#4b5563" stroke-width="1.5"/><text x="38" y="137" fill="#9ca3af" font-size="8" text-anchor="middle">1</text><text x="90" y="137" fill="#9ca3af" font-size="8" text-anchor="middle">2</text><text x="142" y="137" fill="#9ca3af" font-size="8" text-anchor="middle">3</text><text x="194" y="137" fill="#9ca3af" font-size="8" text-anchor="middle">4</text><text x="120" y="150" fill="#6b7280" font-size="8" text-anchor="middle">x</text><text x="32" y="125" fill="#9ca3af" font-size="8" text-anchor="end">2</text><text x="32" y="97" fill="#9ca3af" font-size="8" text-anchor="end">4</text><text x="32" y="69" fill="#9ca3af" font-size="8" text-anchor="end">6</text><text x="32" y="41" fill="#9ca3af" font-size="8" text-anchor="end">8</text><text x="32" y="24" fill="#9ca3af" font-size="8" text-anchor="end">10</text><text x="10" y="72" fill="#6b7280" font-size="8" text-anchor="middle" transform="rotate(-90,10,72)">y</text><circle cx="52" cy="48" r="5" fill="#60a5fa" opacity="0.85"/><circle cx="68" cy="108" r="5" fill="#60a5fa" opacity="0.85"/><circle cx="85" cy="72" r="5" fill="#60a5fa" opacity="0.85"/><circle cx="104" cy="35" r="5" fill="#60a5fa" opacity="0.85"/><circle cx="120" cy="98" r="5" fill="#60a5fa" opacity="0.85"/><circle cx="140" cy="55" r="5" fill="#60a5fa" opacity="0.85"/><circle cx="158" cy="115" r="5" fill="#60a5fa" opacity="0.85"/><circle cx="178" cy="30" r="5" fill="#60a5fa" opacity="0.85"/></svg><p style="font-size:0.65rem;color:#6b7280;margin-top:4px;text-align:center">8 Beobachtungen, zufallig verstreut — kein erkennbares Muster</p>',
        },
        {
          id: 'esf-uebung23-13',
          number: 13,
        ...
        },
        {
          ...
          imageHtml: '<div style="margin-top:8px;overflow-x:auto"><table style="width:100%;border-collapse:collapse;background:#1f2937;border-radius:8px;font-size:0.68rem;min-width:480px"><thead><tr style="background:#111827"><th style="padding:7px 8px;text-align:left;color:#9ca3af;border-bottom:1px solid #374151">Item</th><th style="padding:6px 3px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem;line-height:1.2">stimme gar<br>nicht zu<br>(1)</th><th style="padding:6px 3px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(2)</th><th style="padding:6px 3px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(3)</th><th style="padding:6px 3px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(4)</th><th style="padding:6px 3px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(5)</th><th style="padding:6px 3px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(6)</th><th style="padding:6px 3px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem;line-height:1.2">stimme voll<br>zu (7)</th></tr></thead><tbody><tr style="border-bottom:1px solid #374151"><td style="padding:8px;color:#d1d5db">Ich bin mit diesem Video sehr zufrieden.</td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr><td style="padding:8px;color:#d1d5db">Ich wurde dieses Video gerne in sozialen Medien teilen.</td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:8px"><div style="width:15px;height:15px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr></tbody></table><p style="font-size:0.65rem;color:#6b7280;margin-top:4px">7-Punkte-Likert-Skala · 2 Items zu sozialen Medien</p></div>',
        },
        {
          id: 'esf-uebung23-17',
          number: 17,
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          imageHtml: '<div style="margin-top:8px;overflow-x:auto"><table style="width:100%;border-collapse:collapse;background:#1f2937;border-radius:8px;font-size:0.68rem;min-width:400px"><thead><tr style="background:#111827"><th style="padding:7px 8px;text-align:left;color:#9ca3af;border-bottom:1px solid #374151">Ich fuhle mich gegenwärtig…</th><th style="padding:6px 4px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem;line-height:1.2">uberhaupt<br>nicht (1)</th><th style="padding:6px 4px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(2)</th><th style="padding:6px 4px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(3)</th><th style="padding:6px 4px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem">(4)</th><th style="padding:6px 4px;text-align:center;color:#6b7280;border-bottom:1px solid #374151;font-size:0.6rem;line-height:1.2">sehr<br>(5)</th></tr></thead><tbody><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">entschlossen</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">nervos</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">feindselig</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">wachsam</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">angstlich</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">aufmerksam</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">beschamt</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">inspiriert</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr style="border-bottom:1px solid #374151"><td style="padding:5px 8px;color:#d1d5db">verärgert</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr><tr><td style="padding:5px 8px;color:#d1d5db">aktiv</td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td><td style="text-align:center;padding:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;margin:0 auto"></div></td></tr></tbody></table><p style="font-size:0.65rem;color:#6b7280;margin-top:4px">10 Items — Skala von "uberhaupt nicht" (1) bis "sehr" (5)</p></div>',
        },
        {
          id: 'esf-uebung23-24',
          number: 24,
          ...
          imageHtml: '<div style="background:#1f2937;border-radius:8px;padding:14px;margin-top:8px"><p style="font-size:0.75rem;color:#d1d5db;font-weight:600;margin-bottom:10px;border-bottom:1px solid #374151;padding-bottom:6px">Demographische Angaben</p><div style="margin-bottom:10px"><p style="font-size:0.65rem;color:#9ca3af;margin-bottom:5px">Geschlecht</p><div style="display:flex;gap:14px"><label style="font-size:0.65rem;color:#d1d5db;display:flex;align-items:center;gap:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;flex-shrink:0"></div>Mannlich</label><label style="font-size:0.65rem;color:#d1d5db;display:flex;align-items:center;gap:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;flex-shrink:0"></div>Weiblich</label><label style="font-size:0.65rem;color:#d1d5db;display:flex;align-items:center;gap:5px"><div style="width:13px;height:13px;border-radius:50%;border:2px solid #4b5563;flex-shrink:0"></div>Divers</label></div></div><div style="margin-bottom:10px"><p style="font-size:0.65rem;color:#9ca3af;margin-bottom:5px">Alter</p><div style="background:#374151;border:1px solid #4b5563;border-radius:6px;color:#6b7280;font-size:0.65rem;padding:5px 10px;display:inline-block">Bitte wahlen ▾</div></div><div style="margin-bottom:10px"><p style="font-size:0.65rem;color:#9ca3af;margin-bottom:5px">Hochster Bildungsabschluss</p><div style="background:#374151;border:1px solid #4b5563;border-radius:6px;color:#6b7280;font-size:0.65rem;padding:5px 10px;display:inline-block">Bitte wahlen ▾</div></div><div><p style="font-size:0.65rem;color:#9ca3af;margin-bottom:5px">Haushaltseinkommen</p><div style="background:#374151;border:1px solid #4b5563;border-radius:6px;color:#6b7280;font-size:0.65rem;padding:5px 10px;display:inline-block">Bitte wahlen ▾</div></div></div>',
        },
        {
          id: 'esf-uebung23-25',
          number: 25,
          ...
          imageHtml: '<div style="background:#1f2937;border-radius:8px;padding:12px;margin-top:8px;border-left:3px solid #8b5cf6"><p style="font-size:0.65rem;color:#a78bfa;font-weight:600;margin-bottom:2px">Marketing Scales Handbook</p><p style="font-size:0.75rem;color:#e5e7eb;font-weight:700;margin-bottom:2px">Creative Task Competence</p><p style="font-size:0.6rem;color:#6b7280;margin-bottom:8px">Dahl &amp; Moreau (2007) · Cronbach Alpha = .88 · 4 Items · 9-Punkte-Skala</p><div style="background:#111827;border-radius:6px;padding:8px;font-size:0.65rem"><p style="color:#9ca3af;margin-bottom:6px;font-style:italic">Bitte beurteilen Sie Ihre Leistung bei der Aufgabe:</p><div style="display:flex;align-items:center;gap:4px;margin-bottom:5px"><span style="color:#d1d5db;min-width:120px;text-align:right;font-size:0.6rem">not at all talented</span><div style="display:flex;gap:3px;padding:0 6px"><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div></div><span style="color:#d1d5db;font-size:0.6rem">very talented</span></div><div style="display:flex;align-items:center;gap:4px;margin-bottom:5px"><span style="color:#d1d5db;min-width:120px;text-align:right;font-size:0.6rem">not at all competent</span><div style="display:flex;gap:3px;padding:0 6px"><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div></div><span style="color:#d1d5db;font-size:0.6rem">very competent</span></div><div style="display:flex;align-items:center;gap:4px;margin-bottom:5px"><span style="color:#d1d5db;min-width:120px;text-align:right;font-size:0.6rem">not at all smart</span><div style="display:flex;gap:3px;padding:0 6px"><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div></div><span style="color:#d1d5db;font-size:0.6rem">very smart</span></div><div style="display:flex;align-items:center;gap:4px"><span style="color:#d1d5db;min-width:120px;text-align:right;font-size:0.6rem">not at all intelligent</span><div style="display:flex;gap:3px;padding:0 6px"><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div><div style="width:10px;height:10px;border-radius:50%;border:1.5px solid #4b5563"></div></div><span style="color:#d1d5db;font-size:0.6rem">very intelligent</span></div></div></div>',
        },
        {
          id: 'esf-uebung23-26',
          number: 26,
