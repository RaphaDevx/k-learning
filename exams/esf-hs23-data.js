    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          imageHtml: '<svg width="280" height="170" style="display:block;background:#1f2937;border-radius:8px;margin-top:8px" xmlns="http://www.w3.org/2000/svg"><!-- Axes --><line x1="55" y1="15" x2="55" y2="135" stroke="#4b5563" stroke-width="1.5"/><line x1="55" y1="135" x2="255" y2="135" stroke="#4b5563" stroke-width="1.5"/><!-- Y labels (GPA 78-96) --><text x="49" y="19" fill="#9ca3af" font-size="8" text-anchor="end">96</text><text x="49" y="52" fill="#9ca3af" font-size="8" text-anchor="end">92</text><text x="49" y="85" fill="#9ca3af" font-size="8" text-anchor="end">88</text><text x="49" y="118" fill="#9ca3af" font-size="8" text-anchor="end">84</text><text x="49" y="136" fill="#9ca3af" font-size="8" text-anchor="end">82</text><!-- Y axis grid lines --><line x1="55" y1="19" x2="255" y2="19" stroke="#374151" stroke-width="0.5" stroke-dasharray="3,3"/><line x1="55" y1="52" x2="255" y2="52" stroke="#374151" stroke-width="0.5" stroke-dasharray="3,3"/><line x1="55" y1="85" x2="255" y2="85" stroke="#374151" stroke-width="0.5" stroke-dasharray="3,3"/><line x1="55" y1="118" x2="255" y2="118" stroke="#374151" stroke-width="0.5" stroke-dasharray="3,3"/><!-- X labels (Quintile 1-5) --><text x="75" y="148" fill="#9ca3af" font-size="8" text-anchor="middle">1</text><text x="115" y="148" fill="#9ca3af" font-size="8" text-anchor="middle">2</text><text x="155" y="148" fill="#9ca3af" font-size="8" text-anchor="middle">3</text><text x="195" y="148" fill="#9ca3af" font-size="8" text-anchor="middle">4</text><text x="235" y="148" fill="#9ca3af" font-size="8" text-anchor="middle">5</text><text x="155" y="160" fill="#6b7280" font-size="8" text-anchor="middle">Quintile</text><!-- Selbstdisziplin solid line: Q1=80→Q5=93 (steeper) --><polyline points="75,127 115,95 155,72 195,43 235,25" fill="none" stroke="#60a5fa" stroke-width="2.5"/><circle cx="75" cy="127" r="4" fill="#60a5fa"/><circle cx="115" cy="95" r="4" fill="#60a5fa"/><circle cx="155" cy="72" r="4" fill="#60a5fa"/><circle cx="195" cy="43" r="4" fill="#60a5fa"/><circle cx="235" cy="25" r="4" fill="#60a5fa"/><!-- IQ dashed line: Q1=85→Q5=91 (flatter) --><polyline points="75,118 115,103 155,90 195,75 235,52" fill="none" stroke="#f59e0b" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="75" cy="118" r="4" fill="#f59e0b"/><circle cx="115" cy="103" r="4" fill="#f59e0b"/><circle cx="155" cy="90" r="4" fill="#f59e0b"/><circle cx="195" cy="75" r="4" fill="#f59e0b"/><circle cx="235" cy="52" r="4" fill="#f59e0b"/><!-- Y axis label --><text x="12" y="75" fill="#6b7280" font-size="7.5" text-anchor="middle" transform="rotate(-90,12,75)">GPA (Notendurchschnitt)</text><!-- Legend --><line x1="60" y1="10" x2="80" y2="10" stroke="#60a5fa" stroke-width="2.5"/><text x="83" y="14" fill="#93c5fd" font-size="7.5">Selbstdisziplin (steiler)</text><line x1="168" y1="10" x2="188" y2="10" stroke="#f59e0b" stroke-width="2.5" stroke-dasharray="5,3"/><text x="191" y="14" fill="#fcd34d" font-size="7.5">IQ (flacher)</text></svg><p style="font-size:0.65rem;color:#6b7280;margin-top:4px;text-align:center">GPA als Funktion der Quintile — Duckworth &amp; Seligman (2005)</p>',
        },
        {
          id: 'esf-hs23-16',
          number: 16,
