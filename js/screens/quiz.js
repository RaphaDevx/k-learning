...
window.QuizScreen = (function() {
  ...
  const QUIZ_REGISTRY = [
    ...
    {
      id: 'makro-tb1-teil2',
      label: 'Makro II TB1 — Teil 2: Finanzmärkte & Aktienmarkt',
      subtitle: '13 Fragen · Risikoprämie, Anleihenpreise, QE, Zinsstrukturkurve',
      course: 'MakroII',
    ...
    {
      id: 'makro-tb2',
      label: 'Makro II TB2 — IS-LM, Konsum & Euler-Gleichung',
      subtitle: '20 Fragen · Euler-Gleichung, Tobins q, IS-Kurve, Multiplikator',
      course: 'MakroII',
    ...
    {
      id: 'makro-tb3',
      label: 'Makro II TB3 — Offene Volkswirtschaft & Wechselkurse',
      subtitle: '20 Fragen · PPP, UIP, Mundell-Fleming, SNB-Interventionen',
      course: 'MakroII',
    ...
    {
      id: 'makro-tb4',
      label: 'Makro II TB4 — Inflation, Phillipskurve & NAIRU',
      subtitle: '20 Fragen · Phillipskurve, Lucas-Kritik, Seignorage, EZB',
      course: 'MakroII',
    ...
    {
      id: 'makro-tb5',
      label: 'Makro II TB5 — Staatsausgaben & Fiskalpolitik',
      subtitle: '20 Fragen · Ricardianische Äquivalenz, Budgetbeschränkung, Multiplikator',
      course: 'MakroII',
    ...
    {
      id: 'makro-tb6',
      label: 'Makro II TB6 — Staatsverschuldung & Fiskalregeln',
      subtitle: '20 Fragen · Blanchard r vs g, Schuldenbremse, EU-Pakt, Schuldenquote',
      course: 'MakroII',
